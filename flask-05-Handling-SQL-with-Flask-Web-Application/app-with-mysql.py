...
app.config['MYSQL_DATABASE_HOST'] = 'ozcan-database.c4lz4ovoce56.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Kara123456'
app.config['MYSQL_DATABASE_DB'] = 'daimon'
